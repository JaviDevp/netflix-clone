...
function Row({title, movies}:Props) {
  ...
  return (
    <div className='h-[55] space-y-0.5 md:space-y-2'>
      ...
      <div className='group relative md:-ml-2'>
        ...
        <div ref={rowRef} className='flex scrollbar-hide items-center space-x-2.5 overflow-x-scroll md:space-x-2.5 md:p-2'>
          {movies.map((movie) => (
